...
const Menu = props => {
  ...
  const buildMenu = () => {
    if (winner === human) {
      ...
      return /*#__PURE__*/(
        React.createElement("section", { id: "Menu", className: showMenu ? 'display' : 'display hidden' }, /*#__PURE__*/
          React.createElement("h1", { className: "title" }, "Oops...Sorry!! Win this to get 1,000₹ Reward"), /*#__PURE__*/
        React.createElement("hr", null), /*#__PURE__*/
        React.createElement("div", null, /*#__PURE__*/
